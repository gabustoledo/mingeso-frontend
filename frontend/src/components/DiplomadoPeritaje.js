        ...
        <Tabs defaultActiveKey="Objetivos" id="uncontrolled-tab-example">
          <Tab eventKey="Objetivos" title="Objetivos">
            <div class="tab-pane single active" id="4005">
              <br></br>
              <p>
                El Diplomado está dirigido a abogados, ingenieros informáticos,
                auditores y oficiales de la Fuerzas Armadas o de Orden.
              </p>
              <p>
                Este diplomado tiene como objetivo preparar a profesionales
                relacionados con los procesos de la reforma al sistema de
                justicia nacional en temas informáticos que les permitan
                afrontar, con conocimientos adecuados, las exigencias de esta
                nueva disciplina en el ámbito legislativo, judicial y policial.
              </p>
              <p>
                El programa contempla en su desarrollo, clases, magistrales,
                casos prácticos como teóricos, disertaciones, trabajos grupales,
                trabajos individuales, aplicaciones a una realidad concreta y
                pruebas.
              </p>
            </div>
          </Tab>
          <Tab eventKey="Plan de Estudios" title="Plan de Estudios">
            <div class="tab-pane single" id="4007">
              ...
              <ul>
                <li>
                  El diplomado tiene una duración total de 192 horas y está
                  estructurado en 16 cursos.
                </li>
              ...
              <p>
                El programa de estudios del diplomado en Peritaje Informático
                ofrece 16 cursos.
              </p>
              <ol>
                ...
                <li>
                  Derechos de autor sobre el software, bases de datos y otras
                  tecnologías
                </li>
                <li>Hacking ético</li>
          ...
          <Tab eventKey="Cuerpo Docente" title="Cuerpo Docente">
            <div class="tab-pane single" id="4009">
              ...
              <p>
                ...
                nivel académico o profesionales de reconocido&nbsp;prestigio y
                experiencia laboral.
              </p>
              ...
              <ul>
                ...
                <li>
                  Diplomado en Estado de Derecho y Reformas a la Justicia,
              ...
              <ul>
                <li>
                  Ingeniero Comercial, mención Informática, Universidad de
                  Santiago de Chile.
                </li>
                <li>
                  Diplomado en Peritaje Informático, Universidad de Santiago de
                  Chile.
                </li>
                <li>
                  Diplomado en Control, Seguridad y Auditoría Computacional,
                  Universidad de Santiago de Chile.
                </li>
              </ul>
              ...
              <ul>
                <li>
                  Licenciado en Ciencias Jurídicas y Sociales, Universidad Las
                  Condes. Título de Abogado.
                </li>
                <li>
                  Magíster en Derecho Público con Mención en Derecho
                  Constitucional, Universidad Católica de Chile.
                </li>
              </ul>
              <p>Waldo Gómez Román</p>
              <ul>
                <li>
                  Ingeniero de Ejecución Industrial, Universidad Andrés Bello.
                </li>
                <li>
                  Ingeniero en&nbsp;Gestión de Empresas, Universidad Diego
                  Portales.
                </li>
                <li>
                  Diplomado en Control, Seguridad y Auditoria
                  Computacional,&nbsp;Universidad de Santiago de Chile.
                </li>
                <li>
                  Diplomado en Peritaje Informático,&nbsp;Universidad de
                  Santiago de Chile.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  Perito Informático, Academia Superior de Estudios Policiales,
                  Policía de Investigaciones de Chile.
                </li>
                <li>
                  Diplomado en Criminalística y Metodología Forense, Universidad
                  de Valparaíso.
                </li>
                <li>
                  Diplomado en Control, Seguridad y Auditoria
              ...
              <ul>
                ...
                <li>
                  Diplomado en Auditoría de Sistemas, Universidad de Chile.
                </li>
                <li>
              ...
              <ul>
                <li>
                  Licenciado en Ciencias de la Investigación
                  Criminalística,&nbsp;Academia Superior de Ciencias Policiales,
                  PDI.
                </li>
                <li>
                  Creador y ex jefe de la Brigada Investigadora del Ciber Crimen
                  (Bricib) de la PDI.
                </li>
                <li>Prefecto ® de la Policía de Investigaciones de Chile.</li>
                <li>
                  Diplomado, en Auditoría, Control y Seguridad
                  Informática,&nbsp;Universidad de Santiago de Chile.
                </li>
                <li>
                  Licenciado en Comunicación Publicitaria, Mención Gestión
                  Creativa, Universidad de Santiago de Chile.
                </li>
                <li>
                  Magíster en Didáctica para la Educación
                  Superior,&nbsp;Universidad de Tarapacá.
                </li>
                <li>
                  Doctor en Comunicación,&nbsp;Universidad de Artes, Ciencias y
                  Comunicación.
                </li>
              </ul>
            </div>
          ...
          <Tab eventKey="Aranceles" title="Aranceles">
            <div class="tab-pane single" id="4013">
              ...
              <ul>
                <li>
                  El valor total del diplomado asciende a $ 3.861.000 (valor año
                  2021, 1° Semestre).
                </li>
          ...
          <Tab eventKey="Admisión" title="Admisión">
            <div class="tab-pane single" id="4015">
              ...
              <ul>
                <li>
                  El Programa está dirigido a todas las personas que se
                  encuentren desempeñando funciones tales como abogados,
                  ingenieros informáticos, auditores y oficiales de la Fuerzas
                  Armadas o del Orden.
                </li>
              </ul>
